...
public  class  z390 extends JApplet 
     ...
     * 08/10/14 RPI 1176  COBOL menu items were added             
	 ********************************************************
     ...
     */  
        ...
        JMenuItem file_menu_cob   = null;      
        JMenuItem file_menu_cobl  = null;      
        JMenuItem file_menu_coblg = null;      
	   ...
	   private void set_text_font(){
		    ...
		    */
	          menuBar.setFont(new Font(tz390.z390_font,Font.BOLD,font_size)); //RPI81
   	          ...
   	          file_menu_cob.setFont(new Font(tz390.z390_font,Font.BOLD,font_size));  
   	          file_menu_cobl.setFont(new Font(tz390.z390_font,Font.BOLD,font_size));  
   	          file_menu_coblg.setFont(new Font(tz390.z390_font,Font.BOLD,font_size));  
   ...
   private void build_main_panel(){ 
     ...
     */
     ...
     file_menu_cob    = new JMenuItem("COB..");
     file_menu_cobl   = new JMenuItem("COBL..");
     file_menu_coblg  = new JMenuItem("COBLG..");
     ...
     file_menu_cob.setMnemonic(KeyEvent.VK_K);
     file_menu_cobl.setMnemonic(KeyEvent.VK_M);
     file_menu_coblg.setMnemonic(KeyEvent.VK_Q);
     ...
     file_menu_cob.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_K,ActionEvent.CTRL_MASK));
     file_menu_cobl.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M,ActionEvent.CTRL_MASK));
     file_menu_coblg.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q,ActionEvent.CTRL_MASK));
     ...
     file_menu_cob.addActionListener(this);
     file_menu_cobl.addActionListener(this);
     file_menu_coblg.addActionListener(this);
     ...
     file_menu.add(file_menu_cob);
     file_menu.add(file_menu_cobl);
     file_menu.add(file_menu_coblg);
   ...
   private void set_tooltips(){
	    ...
	    */
	     ...
	     file_menu_cob.setToolTipText(text_font_pfx + "COB compile" + text_font_sfx);
	     file_menu_cobl.setToolTipText(text_font_pfx + "COBL compile, link" + text_font_sfx);
	     file_menu_coblg.setToolTipText(text_font_pfx + "COBLG compile, link, and exec 390" + text_font_sfx);
    ...
    */	
		...
		if (event_name.equals("AMODE31")){
   	  ...
   	  case 'B':
   	    break;
   	  case 'C':	
 	    if (event_name.equals("COB..")){
                batch_cmd("COB","","CBL",cob_opt);
                break;
 	    }
 	    if (event_name.equals("COBL..")){
                batch_cmd("COBL","","CBL",cobl_opt);
                break;
 	    }
     ...
     */	
	    ...
	    private boolean options_command(JCheckBoxMenuItem option_men, String cmd_parm1, String cmd_parm2){
	    	...
	    	if (option_menu_ascii.isSelected()){  // do last to override trace setting NOCON
	    		...
	    		cob_opt   = cob_opt   + " ASCII";
	    		cobl_opt  = cobl_opt  + " ASCII";
	    		coblg_opt = coblg_opt + " ASCII";
	    	...
	    	if (!option_menu_con.isSelected()){  // do last to override trace setting NOCON
	    		...
	    		cob_opt   = cob_opt   + " NOCON";
	    		cobl_opt  = cobl_opt  + " NOCON";
	    		coblg_opt = coblg_opt + " NOCON";
	    	...
	    	if (!option_menu_list.isSelected()){
	    		...
	    		cob_opt   = cob_opt + " NOLIST";
	    		cobl_opt  = cobl_opt + " NOLIST";
	    		coblg_opt = coblg_opt + " NOLIST";
	    	...
	    	if (!option_menu_listcall.isSelected()){
	    		...
	    		cob_opt   = cob_opt   + " NOLISTCALL";
	    		cobl_opt  = cobl_opt  + " NOLISTCALL";
	    		coblg_opt = coblg_opt + " NOLISTCALL";
